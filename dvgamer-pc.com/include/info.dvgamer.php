    ...
    <tr>
      <td>
        ...
        <table class="listgame" align="center" width="95%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td valign="top" width="33" height="20"><strong><a style="color:#000;" href="index.php?option=listgame&sort=list_id<?php echo $pages; ?>">No.</a>
            <?php if($by == "DESC") { ?><img src="images/bullet_DESC.png" border="0" /> <?php } ?> </strong></td>
            <td valign="top" align="left" width="278" ><strong><a style="color:#000;" href="index.php?option=listgame&sort=gname<?php echo $pages; ?>">Name</a></strong></td>
            <td valign="top" align="left" width="75" ><strong><a style="color:#000;" href="index.php?option=listgame&sort=grelease<?php echo $pages; ?>">Release</a></strong></td>
            <td valign="top" align="left" width="124" ><strong><a style="color:#000;" href="index.php?option=listgame&sort=genre_id<?php echo $pages; ?>">Genre</a></strong></td>
            <td valign="top" align="left" width="65" ><strong><a style="color:#000;" href="index.php?option=listgame&sort=box_id<?php echo $pages; ?>">Box</a></strong></td>
            <td valign="top" align="left" width="65" ><strong><a style="color:#000;" href="index.php?option=listgame&sort=gsizes<?php echo $pages; ?>">Size</a></strong></td>
