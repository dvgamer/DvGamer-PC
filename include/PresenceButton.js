...
function Microsoft_Live_Messenger_PresenceButton_startConversation(conversationUrl)
{
    ...
    window.open(url, '_blank', 'height=480px,width=640px');
}
...
function Microsoft_Live_Messenger_PresenceButton_onPresence(presence)
{
    ...
    if (idx >= 0)
    {
        ...
        if (element)
        {
			...
			//outerFrame.style.backgroundImage = 'url(images/liveChat-bg.png)';
           ...
           // innerFrame.style.padding = '10px';
            innerFrame.style.textAlign = 'left';
           ...
           /* if (canvas.getContext)
			...
			if (presence.statusText=='Offline') {
				statusIcon.src = 'images/liveChat/liveChat_Offline.png';
			} else if (presence.statusText=='Away') {
				statusIcon.src = 'images/liveChat/liveChat_Away.png';
			} else if (presence.statusText=='Busy') {
				statusIcon.src = 'images/liveChat/liveChat_Busy.png';
			} else {
				statusIcon.src = 'images/liveChat/liveChat_Online.png';
			}
            statusIcon.width = '145';
            statusIcon.height = '67';
